...
export default function SkillsSection() {
  return (
    <>
      <div className="debug relative flex h-[100vh] w-full flex-col items-center justify-center">
        <h1 className="absolute top-[110px] text-[36px] font-bold text-white">Skills</h1>
